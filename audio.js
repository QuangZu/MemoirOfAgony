...
(function() {
    ...
    const tvSound = new Audio('https://res.cloudinary.com/dxg8llcr2/video/upload/v1764731875/old-tv-click_zvsoba.mp4');
    tvSound.volume = 1.0;

    // VHS noise (continuous on non-video pages)
    const vhsNoise = new Audio('https://res.cloudinary.com/dxg8llcr2/video/upload/v1764731878/810227__jaeblo__vhs-style-noise_poy62a.wav');
    ...
    function initBackgroundMusic() {
        if (!backgroundMusic) {
            backgroundMusic = new Audio('https://res.cloudinary.com/dxg8llcr2/video/upload/v1764731877/NoCopyright_Tense_Cinematic_Background_Music_-_Anxiety_by_soundridemusic_fykdpv.mp3');
